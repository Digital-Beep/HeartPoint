...
namespace heartpoint.NPCs.Boss.Guardian
{
    public class Guardian : ModNPC
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            mod.GetSoundSlot(SoundType.Music, "Items/Music/GAMEOVER");
            musicPriority = MusicPriority.BossLow; // By default, musicPriority is BossLow
        }
        ...
        public override void AI()
        {
            ...
            else if(npc.ai[0] == 0.3f)
            {
                ...
                if (npc.ai[1]++ > 2)
                {
                    ...
                    Projectile.NewProjectile(npc.Center, toPlayer, ProjectileID.PurpleLaser, npc.damage, 20, Main.myPlayer);
                    npc.ai[2]++;
                    npc.ai[1] = 0;
                }
